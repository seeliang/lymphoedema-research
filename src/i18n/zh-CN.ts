...
zhCNEditionTranslations["2026.08.5"] = {
  ...
  summary: "根据现有研究，说明哪些护理方法已有依据、哪些新方法可能有帮助、哪些问题还需要确认，并列出每项结论的来源。",
  changes: [
    ...
    "按淋巴水肿专科沟通标准重审中文，用适合中学文化水平读者的短句解释医学和研究术语。",
  ],
  evidenceOverview: {
    "established-foundations": {
      title: "常用护理已有明确依据",
      summary: "现行指导意见建议根据个人情况选择加压治疗、皮肤护理、活动和运动，以及合适的综合消肿疗法，也就是把多种护理方法组合使用。这些是淋巴水肿护理的基础。",
      sourceLabels: [
    ...
    "selected-options": {
      title: "较新的方法可能帮助部分人",
      summary: "新的加压护理方式、渐进式力量训练和专科显微手术，可能帮助特定人群。但现有研究不能说明其中任何一种方法适合所有人。",
      sourceLabels: [
        "可调式加压包扎随机研究（英文）",
        "数字化支持治疗研究（英文）",
        "力量训练预防系统综述（英文）",
    ...
    "evidence-strength": {
      title: "研究方法不同，结论的可靠程度也不同",
      summary: "小型研究、随机试验、系统综述和只有注册信息的试验，能支持的结论并不一样。试验如果还没有公布结果，就不能说明治疗有效。",
      sourceLabels: [
  ...
  sectionContexts: {
    treatmentManagement: {
      intro: "淋巴水肿护理要根据个人情况制定。现行指导意见把加压治疗、皮肤护理、活动和运动，以及综合消肿疗法列为核心方法。经过专科评估后，部分患者也可以考虑专科治疗或手术。",
      sourceLabels: [
    ...
    medicines: {
      intro: "对于没有其他并发症的手臂、腿部等外周淋巴水肿，目前没有哪种药物被确立为常规治疗。抗生素用于治疗已经确诊的蜂窝织炎等感染，不是一般的淋巴水肿治疗。除非同时有其他疾病或并发症，通常不建议长期使用利尿剂。GLP-1 试验只有注册信息，还没有公布结果，因此不能作为治疗建议。",
      sourceLabels: [
        "国际淋巴学会共识：分子与药物研究（英文）",
        "国际淋巴学会共识：利尿剂与抗生素（英文）",
  ...
  childrenSection: {
    summary: "最近一次检索覆盖了过去 45 天，找到 5 篇涉及儿童或青少年的论文候选资料，以及 3 条近期更新的试验注册记录。这些资料还没有逐篇核对原始来源，因此暂时没有放进面向患者的证据摘要。",
  },
  deferredCandidates: {
    ...structuredClone(zhCNEditionTranslations["2026.08.4"].deferredCandidates ?? {}),
    "PMID 40081785": {
      ...structuredClone(zhCNEditionTranslations["2026.08.4"].deferredCandidates!["PMID 40081785"]),
      title: "定期检查淋巴水肿迹象并运动，能否预防高风险患者在乳腺癌治疗后出现淋巴水肿：随机试验",
      reason: "这项试验和已经总结的力量训练预防研究内容很接近，所以本期不再单独列为证据。",
      revisitWhen: "下次更新运动研究时再评估。如果它会明显改变现有结论，应提前复核。",
    },
    "PMID 41886031": {
      ...structuredClone(zhCNEditionTranslations["2026.08.4"].deferredCandidates!["PMID 41886031"]),
      title: "采用 LYMPHA 技术预防乳腺癌治疗后上肢淋巴水肿：在一个医疗中心进行的 15 年随访研究",
      reason: "15 年随访可能有价值，但研究不是随机分组，只在一个研究中心开展，而且跨越了很长的治疗时期。需要仔细判断患者是怎样被选入研究的。",
      revisitWhen: "完整核对患者如何选择、对照组、随访、可能的不良影响、研究经费和利益冲突后，再评估是否纳入。",
    },
    "PMID 42294341": {
      ...structuredClone(zhCNEditionTranslations["2026.08.4"].deferredCandidates!["PMID 42294341"]),
      title: "乳腺癌相关淋巴水肿的非药物治疗：汇总随机分组试验，并用统计方法比较多种治疗",
      reason: "在向患者介绍各种治疗的排序前，需要先确认研究是否有偏差、不同治疗能否公平比较、各研究结果差异多大，以及证据是否可靠。",
      revisitWhen: "等人工完成这篇比较多种治疗的系统综述的复核后，再考虑是否纳入。",
    },
  },
  trials: {
    ...structuredClone(zhCNEditionTranslations["2026.08.4"].trials),
    NCT05890677: {
      ...structuredClone(zhCNEditionTranslations["2026.08.4"].trials.NCT05890677),
      design: "一项在多个国家、多个研究中心开展的随机试验，按接近日常医疗的方式比较显微手术和综合消肿疗法",
      caution: "试验正在招募，不代表手术效果更好。研究的主要观察阶段还没有完成，目前没有结果可以报告。",
    },
    NCT07012642: {
      ...structuredClone(zhCNEditionTranslations["2026.08.4"].trials.NCT07012642),
      title: "研究一类叫作 GLP-1 受体激动剂的药物对上肢和下肢淋巴水肿是否有效",
      design: "一项很早期的 I 期试验，也就是这种药物用于淋巴水肿患者的初步研究。所有参加者都知道自己接受了什么治疗，而且研究没有设置对照组",
      caution: "这项早期试验没有对照组，也还没有公布结果。它不能证明 GLP-1 类药物能够治疗淋巴水肿，也不是用药建议。",
    },
  },
  evidence: {
    ...
    "compression-self-management": {
      ...
      studyDesign: "两项小型研究。一项有 24 人，随机比较可调式加压包扎和多层绷带，看前者减小小腿体积的效果是否不比后者差。另一项跟踪一组接受数字指导护理的患者，没有设置对照组。",
      takeaway: "第一项小型试验发现，可调式加压包扎减小小腿体积的效果与多层绷带相近，而且使用起来更快。另一项没有对照组的研究发现，接受数字指导护理后，患者情况也有所改善。",
      meaning: "更灵活的加压方式，加上专业人员指导的自我护理，可能让一些人更容易完成日常护理。加压用品要由合格专业人员帮助选择，并提供使用培训和随访。",
      limitation: "两项研究的人数都很少，其中一项只在一个研究中心开展，数字护理研究也没有对照组。因此，不能说明其中一种方法适合所有身体部位或所有淋巴水肿阶段。",
    },
    "resistance-training": {
      ...structuredClone(zhCNEditionTranslations["2026.08.4"].evidence["resistance-training"]),
      population: "接受乳腺癌手术并有淋巴水肿风险的女性。另一篇范围更广的综述还包括已经患有乳腺癌相关淋巴水肿的人。",
      studyDesign: "两篇 2026 年的系统综述和荟萃分析，也就是把多项随机试验的结果汇总分析。一篇关注预防，纳入 11 项试验和 1,450 名女性；另一篇范围更广，纳入 38 项试验和 4,843 人。解读时还参考了一项随机试验的长期随访。",
      takeaway: "关注预防的综述发现，进行渐进式力量训练的人发生乳腺癌相关淋巴水肿的比例较低。研究人员认为这项证据的可靠程度为中等。另一篇综述也报告了较低的发生率，肢体状况也有所改善。",
      meaning: "在专业人员适当指导下，力量训练可以作为乳腺癌治疗后康复的一部分。但它不能保证预防淋巴水肿，也不能代替个人评估。",
      limitation: "参加者知道自己是否在做力量训练。各研究采用的训练方法和淋巴水肿定义也不相同。范围更广的综述把预防人群和已经患病的人群放在一起分析，而且各研究结果差异较大。长期随访时，原来的参加者中接近一半没有参加最后一次随访。",
    },
    microsurgery: {
      ...structuredClone(zhCNEditionTranslations["2026.08.4"].evidence.microsurgery),
      title: "显微手术可能减少蜂窝织炎，但不同疗效并不一致",
      population: "继发性下肢淋巴水肿患者。参考的其他手术综述还包括不同病因和不同疾病阶段的患者。",
      studyDesign: "一项在多个研究中心开展的随机试验，比较两种方法：一组接受淋巴管静脉吻合术，也就是用显微手术把淋巴管接到小静脉，并继续接受综合消肿疗法；另一组只接受综合消肿疗法。解读时还参考了一篇 2026 年综述，这篇综述汇总了多篇系统综述。",
      takeaway: "随机试验发现，接受淋巴管静脉吻合术的人发生蜂窝织炎（一种皮肤感染）的次数较少，但患肢周长和疼痛没有明显差异。范围更广的综述认为手术可能有帮助，不过各项证据的质量并不一致。",
      meaning: "经过医生仔细评估和筛选后，部分患者可以考虑专科手术，尤其是反复发生蜂窝织炎的人。手术只是保守治疗之外的一个选择。",
      limitation: "不同研究采用的手术方法、选择患者的标准、评估疗效的指标和随访时间差别很大。许多手术研究的证据质量较低或极低。即使接受手术，患者仍需要持续的专科护理。",
      sourceLabels: [
        "Mihara 等，多中心随机临床试验（2023，英文）",
        "Gloviczki 等，汇总多篇系统综述的研究（2026，英文）",
      ],
    },
    "primary-biology": {
      ...structuredClone(zhCNEditionTranslations["2026.08.4"].evidence["primary-biology"]),
      area: "原发性淋巴水肿的病因研究",
      studyDesign: "两项小型研究。一项进行基因测序；另一项比较 15 名患者和 8 份健康人的组织样本。",
      takeaway: "研究人员发现，FLT4 基因中有一种新的变化，可能与疾病有关。他们还发现，患者组织中血管让液体漏出的情况，以及淋巴系统细胞之间传递信息的方式，可能与健康人不同。",
      meaning: "这些发现可能帮助研究人员更准确地区分不同类型的原发性淋巴水肿，并根据不同病因设计后续研究。",
      limitation: "两项研究的人数都很少，结果还需要其他研究重复验证。2026 年的研究也没有得出一致、明确的手术疗效。这些研究还没有带来新的常规治疗。",
    },
    "icg-imaging": {
      ...structuredClone(zhCNEditionTranslations["2026.08.4"].evidence["icg-imaging"]),
      studyDesign: "一篇系统综述，汇总了 11 项使用吲哚菁绿淋巴造影的研究",
      takeaway: "ICG 淋巴造影可以显示皮肤附近的淋巴液流动，而且检查时不会受到放射线照射。它可能帮助医生诊断、制定治疗方案和观察病情变化。",
      meaning: "如果诊断比较复杂，或者需要规划手术，这类专科影像检查可能提供更多信息。",
      limitation: "各项研究的注射部位、检查方法、报告方式和患者情况都不相同。因此，这篇综述无法确定一套统一的检查流程，也不能说明每个人都需要做 ICG 淋巴造影。",
    },
  },
}
