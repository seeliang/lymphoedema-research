...
export const zhCNUI = {
  ...
  disclaimer: {
    ...
    responsibilityBody: "您需要对自己的健康决定负责。本页不能代替专业医疗建议。在法律允许的范围内，本项目不对因依赖本页一般信息而造成的损失承担责任。本说明不影响法律规定不能排除的权利或责任。",
  },
  translationNotice: {
    title: "关于这份中文稿",
  ...
  takeaways: {
    ...
    items: [
      ...
      ["研究方法会影响结论可信度", "小型探索性研究和只有注册信息、还没有结果的试验，与经过重复验证并关注患者真正关心结果的随机研究，不是同一级别的证据。"],
    ],
  },
  evidenceFirst: {
    navigation: {
    ...
    overview: {
      eyebrow: "先看证据结论",
      title: "现有研究支持什么",
      intro: "以下内容分成三类：已有依据的护理、可能帮助部分人的方法，以及证据还不够的问题。",
      references: "直接查看依据",
      status: {
        supported: "现行指导意见支持",
        selected: "可能帮助部分人",
    ...
    sections: {
      ...
      medicines: {
        ...
        empty: "本期没有已完成原始来源审查的药物研究。下面的说明来自现行指导意见。GLP-1 试验只有注册信息，还没有公布结果。",
        trialTitle: "正在研究，尚无结果",
      },
      children: {
        title: "儿童和青少年",
      ...
      diagnosis: {
        title: "认识与诊断",
        intro: "病因和影像检查研究可以帮助医生认识或评估淋巴水肿，但不能单独证明某种治疗有效。",
      },
      other: {
        title: "其他研究",
        intro: "不属于以上栏目的已审查证据会继续显示在这里。页面标题只用于整理研究，不会限制哪些资料可以纳入考虑。",
      },
      contextSources: "指导意见和背景资料",
    },
    footer: {
  ...
  evidence: {
    ...
    intro: "每则摘要都会说明研究了谁、怎样研究、发现了什么，以及还有哪些重要局限。",
    groups: {
      children: {
        title: "儿童和青少年",
      ...
      understandingDiagnosis: {
        title: "了解病因和诊断",
        intro: "病因和影像检查研究可以帮助医生理解或评估淋巴水肿，但不能单独证明某种治疗有效。",
      },
      treatmentManagement: {
        title: "治疗与管理",
  ...
  deferred: {
    eyebrow: "等待进一步评估",
    title: "暂缓处理的证据",
    intro: "这些资料可能有用，但本期不会用它们支持结论。每项资料都说明了暂缓原因，以及什么时候再评估。",
    reason: "暂缓原因",
    revisit: "重新评估条件",
    source: "查看资料来源",
  },
  ...
  guide: {
    ...
    items: [
      ["随机证据", "研究人员随机把参加者分到不同组。这样可以减少研究偏差，但不能完全消除。"],
      ["系统综述", "研究人员把多项研究找出来、整理并一起评估。结论是否可靠，仍取决于原研究的质量。"],
      ["早期临床证据", "人数较少，或者没有对照组的早期人体研究。还需要更严格的研究确认。"],
      ["机制性证据", "研究基因、组织或身体内的变化。它能帮助了解病因，但不能证明治疗有效。"],
    ],
  },
  care: {
    eyebrow: "在澳大利亚寻求帮助",
    title: "可以把这些研究带给专业人员讨论",
    body: "新出现或加重的肿胀应请专业人员评估，因为不少情况看起来很相似。ALA 认可的从业人员可以帮助安排诊断和转诊、选择合适的压力衣、指导活动和皮肤护理，并制定适合个人的护理方案。",
  ...
  method: {
    eyebrow: "我们怎样整理本期内容",
    title: "来源和方法公开",
    body: "我们从全球资料中选择对患者有实际意义的研究，并通过 PubMed、论文发表记录或 ClinicalTrials.gov 核对出处。常规护理的说明参考国际淋巴学会共识和澳大利亚患者指南。",
