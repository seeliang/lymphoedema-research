...
describe("research discovery normalisation", () => {
  ...
  it("produces an auditable issue checklist", () => {
    ...
    expect(digest).toContain("do not limit eligible research topics")
    ...
    expect(digest).toContain("It does not limit the research area")
    expect(digest).not.toContain("This is a main report section")
