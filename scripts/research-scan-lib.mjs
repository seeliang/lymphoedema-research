...
export function formatDigest({
  ...
  lines.push(
    ...
    "",
    "These are focused subsets of the broad new PubMed candidate list. They make location-specific evidence easier to find but do not limit eligible research topics or replace full editorial assessment.",
    "",
    "### Arm and upper limb",
    "",
  )
  ...
  lines.push(
    ...
    "",
    "This dedicated report section covers lymphoedema research and trial records involving children or adolescents across treatment, diagnosis, biology, prevention, quality of life, and any other relevant topic. It does not limit the research area, create a lower evidence standard, or imply that adult findings apply to younger people.",
    "",
    "### PubMed candidates",
    "",
  )
